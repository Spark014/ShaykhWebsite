...
export default function GlobalError({
  ...
  useEffect(() => {
    ...
    // Add language change listener if needed, though for a global error boundary,
    // it might be simpler to default or use a very basic toggle.
  }, [error]);
...
// Minimal functional component for useState and useEffect before hydration.
// This is to avoid the "Functions cannot be passed directly to Client Components" error with error components.
